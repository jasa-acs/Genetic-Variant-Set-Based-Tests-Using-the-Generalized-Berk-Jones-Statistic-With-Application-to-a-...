...
# Each job should produce one file with a name like 'power_results_S1_aID1_beta10.txt'
...
# After all runs from this script as well as gen_sim_data_supptab4.R have been completed, use 
...
out_name <- paste('power_results_S', Snum, '_', aID, 'betaconstant.txt', sep='')
