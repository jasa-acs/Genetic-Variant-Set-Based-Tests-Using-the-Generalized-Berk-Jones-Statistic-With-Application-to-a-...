...
# The purpose of this script is to run the simulations that are displayed in Supplementary Figures 4,5,6
...
# In these simulations we vary the sample size and keep constant the effect size.
...
# After all of these jobs have output their data, use plot_suppfig456.R to create plots similar to Supplementary Figures 4,5,6.
# Since HAPGEN sets a seed for its random number generator according to the time of day, 
# it is not possible to recreate the exact simulations that led to Supplementary Figure 4.5.6.
