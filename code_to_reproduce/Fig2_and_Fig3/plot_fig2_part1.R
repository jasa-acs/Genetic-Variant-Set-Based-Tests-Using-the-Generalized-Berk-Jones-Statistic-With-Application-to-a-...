# The purpose of this script is to plot the figure in the left panel of Figure 2
...
# of the lines.
# Output is the image file d100_0_0_0.eps.
...
##################################################################
# Make plot for simulation 1 (corresponds to left panel of fig 2)
xlab_tex = expression('Number of causal SNPs')
main_tex = expression(paste('100 SNPs, ' , rho[1], '=0, ', rho[2], '=0, ', rho[3], '=0'))

postscript("d100_0_0_0.eps", width=720, height=500)
...
legend(x=7.5, y=0.45, c('GBJ', 'GHC', 'MinP', 'SKAT', 'OMNI'), col=c(2,3,4,1,6), 
		lwd=rep(3,5), lty=c(1, 2, 3, 4, 5), cex=2, bty='n')
