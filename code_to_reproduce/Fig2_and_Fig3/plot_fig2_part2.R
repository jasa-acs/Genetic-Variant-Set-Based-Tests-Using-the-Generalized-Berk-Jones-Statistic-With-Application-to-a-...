# The purpose of this script is to plot the figure in the right panel of Figure 2
...
# of the lines.
# Output is the image file d100_3_0_0.eps.
...
##################################################################
# Make plot for simulation 2 (corresponds to right panel of fig 2)
xlab_tex = expression('Number of causal SNPs')
main_tex = expression(paste('100 SNPs, ' , rho[1], '=0.3, ', rho[2], '=0, ', rho[3], '=0'))

postscript("d100_3_0_0.eps", width=720, height=500)
