# The purpose of this script is to plot the figure in the left panel of Figure 3
...
# of the lines.
# Output is the image file d100_3_0_3.eps.
...
##################################################################
# Make the plot for simulation 6 (corresponds to left panel of Figure 3)
xlab_tex = expression('Number of causal SNPs')
main_tex = expression(paste('100 SNPs, ' , rho[1], '=0.3, ', rho[2], '=0, ', rho[3], '=0.3'))

postscript("d100_3_0_3.eps", width=720, height=500)
...
legend(x=1, y=1, c('GBJ', 'GHC', 'MinP', 'SKAT', 'OMNI'), col=c(2,3,4,1,6), 
