...
# The purpose of this script is to run the simulations which produced Figures 2 and 3
...
# Each job should produce one file with a name like 'power_results_S1_aID1.txt'
...
# After all runs from this script as well as gen_omni_data_fig2.R have been completed, use 
...
libs <- '/n/home/user/Rlibrary/3.0.1'
